...
import com.nanz.musify.data.innertube.models.HomeSection
import com.nanz.musify.data.innertube.models.LyricsItem
import com.nanz.musify.data.innertube.models.SearchResult
...
class MusicViewModel(
    ...
    private val _currentLyrics = MutableStateFlow<LyricsItem?>(null)
    val currentLyrics: StateFlow<LyricsItem?> = _currentLyrics.asStateFlow()
    ...
    fun loadLyrics(browseId: String) {
        viewModelScope.launch {
            val lyrics = repository.getLyrics(browseId)
